...
<body>
   ...
   <%-- Link to the new Module 7 add-a-movie feature --%>
    ...
    <p><a href="addMovie.jsp">Add a new movie</a></p> <!--new buttons added to provide access to new features for this module. This was from Module 7  --> 
    <p><a href="allMovies.jsp">View all movies</a></p>
    <!-- Added link for Module 8 revisions, added a txt banner to let the user know this feature is new  -->
    <p><a href="updateSelect.jsp">Update a movie</a> <span style="color:green; font-weight:bold;">(New for Module 8)</span></p>
